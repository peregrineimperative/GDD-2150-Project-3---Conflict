...
//Cards slots are generated a row at a time instead of individually to help discern if they are a frontline/backline slot.

//Rows have four built-in functions:
	...
	//get_name() returns the name of the row (frontline or backline)

function spawn_slot_row(_faction, _board, _layer, _start_x, _start_y, _board_angle, _count, _name){	
	...
	for (var i = 0; i < _count; ++i) {
	    ...
	    //Position each slot with a constant step on x-axis based on the CARD_BUFFER size
