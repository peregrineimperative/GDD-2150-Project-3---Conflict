...
global.cards = ["chivalry", "ironclad", "spearman", "fool", "lich", "skeleton", "archer", "cannon", "wizard"]
randomise()
...
spawn_card(100, 200, global.cards[irandom_range(0, array_length(global.cards) - 1)], "Army");
